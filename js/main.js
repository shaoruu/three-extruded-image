...
import { ExtrudedImage, ExtrudedImageOptions } from './extruder.js';
import {
  DirectionalLight,
  HemisphereLight,
  PointLight,
...
function main() {
  ...
  function setupPanAndZoom(canvas, img) {
  ...
  function updateMesh(img, thickness) {
    const options = {
...
function createControlsContainer(parent) {
...
function createCanvasContainer(parent) {
...
function createFileInput(parent) {
...
function createThicknessSlider(parent) {
...
function createCanvases(parent) {
